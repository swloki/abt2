...
```bash
agent-browser open "https://localhost:8000/admin/quotations/28"
...
4. **用 agent-browser 刷新实现页面**：
   ```bash
   agent-browser open "https://localhost:8000/admin/xx/..."
   agent-browser snapshot
   ```
...
- 实现 URL 格式：`https://localhost:8000/admin/<route>`
