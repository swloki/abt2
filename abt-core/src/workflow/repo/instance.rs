...
impl WorkflowInstanceRepo {
    pub async fn insert(executor: &mut sqlx::postgres::PgConnection, p: &InstanceInsertParams<'_>) -> Result<i64> {
    ...
    pub async fn update_status(executor: &mut sqlx::postgres::PgConnection, id: i64, status: &str) -> Result<()> {
