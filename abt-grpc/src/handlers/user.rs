...
impl GrpcUserService for UserHandler {
    async fn create_user(
        ...
        let user_id = srv.create(1, create_req, &mut tx).await
            .map_err(|e| Status::internal(e.to_string()))?;

        tx.commit().await.map_err(|e| Status::internal(e.to_string()))?;

        // Fetch the created user to return
        let user_with_roles = srv.get(user_id).await
            .map_err(|e| Status::internal(e.to_string()))?
    ...
    async fn update_user(
        ...
        srv.update(1, req.user_id, update_req, &mut tx).await
            .map_err(|e| Status::internal(e.to_string()))?;

        tx.commit().await.map_err(|e| Status::internal(e.to_string()))?;

        // Fetch the updated user to return
        let user_with_roles = srv.get(req.user_id).await
            .map_err(|e| Status::internal(e.to_string()))?
            .ok_or_else(|| Status::not_found("User not found"))?;
    ...
    async fn delete_user(
        ...
        srv.delete(1, req.user_id, &mut tx).await
            .map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn assign_roles(
        ...
        srv.assign_roles(1, req.user_id, req.role_ids, &mut tx).await
            .map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn remove_roles(
        ...
        srv.remove_roles(1, req.user_id, req.role_ids, &mut tx).await
            .map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn batch_assign_roles(
        ...
        srv.batch_assign_roles(1, req.user_ids, req.role_ids, &mut tx).await
            .map_err(|e| Status::internal(e.to_string()))?;
