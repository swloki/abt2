            ...
            form hx-post=(EditCustomerPath { id: c.id }.to_string()) hx-swap="none" {
                    ...
                    div class="grid grid-cols-2 gap-4 gap-x-6 mb-6" {
                        ...
                        div class="form-field" {
                            ...
                            select name="industry" {
                                ...
                                option value="电子制造" selected[industry_val == "电子制造"] { "电子制造" }
                                option value="精密模具" selected[industry_val == "精密模具"] { "精密模具" }
                                option value="光电科技" selected[industry_val == "光电科技"] { "光电科技" }
                                option value="半导体" selected[industry_val == "半导体"] { "半导体" }
                                option value="陶瓷机械" selected[industry_val == "陶瓷机械"] { "陶瓷机械" }
                                option value="自动化技术" selected[industry_val == "自动化技术"] { "自动化技术" }
                        ...
                        div class="form-field" {
                            ...
                            select name="region" {
                                ...
                                option value="华南地区" selected[region_val == "华南地区"] { "华南地区" }
                                option value="华东地区" selected[region_val == "华东地区"] { "华东地区" }
                                option value="华北地区" selected[region_val == "华北地区"] { "华北地区" }
                                option value="西南地区" selected[region_val == "西南地区"] { "西南地区" }
                ...
                div class="bg-bg border border-border-soft rounded-md p-5 mb-5 shadow-[var(--shadow-card)]" {
                    ...
                    div class="grid grid-cols-2 gap-4 gap-x-6 mb-6" {
                        ...
                        div class="form-field" {
                            label { "固定电话" }
                            input type="tel" name="contact_fixed_phone" placeholder="例如：0755-8866-2201"
                    ...
                    div class="grid grid-cols-2 gap-4 gap-x-6 mb-6" {
                        ...
                        div class="form-field" {
                            ...
                            select name="source" {
                                ...
                                option value="自主开发" selected[source_val == "自主开发"] { "自主开发" }
                                option value="展会获客" selected[source_val == "展会获客"] { "展会获客" }
                                option value="老客户转介" selected[source_val == "老客户转介"] { "老客户转介" }
                                option value="网络推广" selected[source_val == "网络推广"] { "网络推广" }
                            }
                        }
                        div class="form-field field-full" {
                            label { "备注" }
                            textarea name="remark" placeholder="请输入备注信息…" rows="4" { (c.remark) }
                        }
                    }
                }
                ...
                div class="flex items-center justify-end gap-3 pt-4 border-t border-border-soft" {
                    button type="button" class="inline-flex items-center gap-2 rounded-sm text-sm font-medium cursor-pointer whitespace-nowrap relative bg-white text-fg border border-border hover:bg-surface" onclick=(format!("location.href='{}'", detail_path)) { "取消" }
