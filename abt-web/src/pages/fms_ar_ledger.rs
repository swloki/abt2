        ...
        div {
            div class="flex items-center justify-between mb-5" {
                ...
                div class="flex gap-3" {
                    a href=(ArLedgerPath) class=(format!("btn btn-sm {}", if q.outstanding_only.unwrap_or(true) { "btn-primary" } else { "btn-outline" }))
                        hx-get=(ArLedgerPath) hx-target="#data-card" hx-select="#data-card" hx-push-url="true"
