                ...
                div class="form-section" {
                    ...
                    div class="grid grid-cols-2 gap-4 gap-x-6 mb-6" {
                        ...
                        div class="form-field" {
                            ...
                            input class="w-full px-3 py-2 border border-border rounded-sm text-sm bg-white text-fg transition-all duration-150 outline-none focus:border-accent font-mono text-right" type="number" name="opening_balance" step="any" min="0" value="0";
                        }
                        // 复选项：明细科目 / 需辅助核算
                        div class="form-field" {
