...
fn empty_row_fragment() -> Markup {
 ...
 td { input class="num-input w-[90px] text-right text-[13px] font-mono px-2 py-[5px] border border-border rounded-sm bg-white text-fg outline-none focus:border-accent focus:shadow-[var(--shadow-focus)]" type="number" step="any" name="quantity" placeholder="0" {} }
 ...
 td { input class="num-input w-[110px] text-right text-[13px] font-mono px-2 py-[5px] border border-border rounded-sm bg-white text-fg outline-none focus:border-accent focus:shadow-[var(--shadow-focus)]" type="number" step="any" name="estimated_price" placeholder="0.00" {} }
