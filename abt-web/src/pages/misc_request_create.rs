...
fn empty_row_fragment() -> Markup {
 html! {
    tr  oninput="if(!event.target.classList.contains('num-input'))return;const r=this,q=parseFloat(r.querySelector('[name=quantity]').value)||0,p=parseFloat(r.querySelector('[name=estimated_price]').value)||0;r.querySelector('.line-subtotal').textContent=(q*p).toFixed(2)"
    {
        ...
        td {
            input
                class="w-full text-[13px] px-2 py-[5px] border border-border rounded-sm bg-white text-fg outline-none focus:border-accent focus:shadow-[var(--shadow-focus)]"
                type="text"
                name="item_name"
                required
                placeholder="物品名称" {}
        ...
        td {
            input
                class="num-input w-[90px] text-right text-[13px] font-mono px-2 py-[5px] border border-border rounded-sm bg-white text-fg outline-none focus:border-accent focus:shadow-[var(--shadow-focus)]"
                type="number"
                step="any"
                name="quantity"
                placeholder="0" {}
        ...
        td {
            input
                class="w-[70px] text-center text-[13px] px-2 py-[5px] border border-border rounded-sm bg-white text-fg outline-none focus:border-accent focus:shadow-[var(--shadow-focus)]"
                type="text"
                name="unit"
                placeholder="单位" {}
        }
        td {
            input
                class="num-input w-[110px] text-right text-[13px] font-mono px-2 py-[5px] border border-border rounded-sm bg-white text-fg outline-none focus:border-accent focus:shadow-[var(--shadow-focus)]"
                type="number"
                step="any"
