...
pub mod wms_stock_out_list;
pub mod wms_stock_out_create;
pub mod wms_stock_out_detail;
pub mod wms_arrival_list;
pub mod wms_arrival_create;
pub mod wms_arrival_detail;
pub mod wms_transfer_list;
pub mod wms_transfer_create;
pub mod wms_transfer_detail;
pub mod wms_requisition_list;
pub mod wms_requisition_create;
pub mod wms_requisition_detail;
...
pub mod wms_cycle_count_list;
pub mod wms_cycle_count_create;
pub mod wms_cycle_count_detail;
