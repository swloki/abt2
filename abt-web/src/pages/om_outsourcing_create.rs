...
fn create_page(
 ...
 input class="w-full px-3 py-2 border border-border rounded-sm text-sm bg-white text-fg outline-none transition-all duration-150 focus:border-accent" type="number" step="any" name="routing_id" placeholder="请输入工序ID";
 }
 div class="form-field" {
