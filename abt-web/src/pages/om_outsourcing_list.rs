        ...
        div {
            div class="flex items-center justify-between mb-6" {
                ...
                div class="flex gap-3" {
                    @if can_create {
                        a class="inline-flex items-center gap-2 rounded-sm text-sm font-medium cursor-pointer whitespace-nowrap relative bg-accent text-accent-on border-none hover:bg-accent-hover" href=(OmOutsourcingCreatePath::PATH) {
    ...
    html! {
        div class="plan-list-panel" {
            ...
            form class="flex items-center gap-3 mb-5 flex-wrap filter-form" id="outsourcing-filter-form"
                ...
                a href=(OmOutsourcingListPath::PATH) class="inline-flex items-center gap-2 rounded-sm text-sm font-medium cursor-pointer whitespace-nowrap relative bg-white text-fg border border-border hover:bg-surface" style="height:36px;text-decoration:none" { "重置" }
            }
