...
pub async fn get_pay_table(
    ...
    Ok(Html(pay_table_fragment(&result, &supplier_names, &suppliers.items, &params).into_string()))
}
...
fn pay_list_page(
    ...
    html! {
        div {
            ...
            (pay_table_fragment(result, supplier_names, suppliers, params))
        }
    }
}
