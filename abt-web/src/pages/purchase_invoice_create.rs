...
function addInvoiceLine() {{
    ...
    row.innerHTML =
        ...
        + '<td class="px-3 py-2 border-b border-border-soft"><input class="w-[80px] text-right px-2.5 py-1.5 border border-border rounded-sm text-sm font-mono outline-none focus:border-accent" type="number" step="any" name="quantity" placeholder="0" oninput="lineItemCalc(\'#purchase-invoice-item-tbody\').calcRow(this.closest(\'tr\'))"></td>'
        + '<td class="px-3 py-2 border-b border-border-soft"><input class="w-[100px] text-right px-2.5 py-1.5 border border-border rounded-sm text-sm font-mono outline-none focus:border-accent" type="number" step="any" name="unit_price" placeholder="0.00" oninput="lineItemCalc(\'#purchase-invoice-item-tbody\').calcRow(this.closest(\'tr\'))"></td>'
