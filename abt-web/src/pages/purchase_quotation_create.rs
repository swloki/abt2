...
fn item_row_fragment(product: &abt_core::master_data::product::model::Product) -> Markup {
 ...
 td { (product.pdt_name) }
 td { input class="w-full px-3 py-2 border border-border rounded-sm text-sm bg-white text-fg transition-all duration-150 outline-none focus:border-accent focus:shadow-[var(--shadow-focus)] num-input" type="number" placeholder="0.00" class="w-[110px] text-right text-[13px] font-mono" class="rounded-sm" class="px-2 py-[5px] border border-border" name="item_unit_price" {} }
 td { input class="w-full px-3 py-2 border border-border rounded-sm text-sm bg-white text-fg transition-all duration-150 outline-none focus:border-accent focus:shadow-[var(--shadow-focus)] num-input" type="number" placeholder="—" class="w-[90px] text-right text-[13px] font-mono" class="rounded-sm" class="px-2 py-[5px] border border-border" name="item_min_order_qty" {} }
 td { input class="w-full px-3 py-2 border border-border rounded-sm text-sm bg-white text-fg transition-all duration-150 outline-none focus:border-accent focus:shadow-[var(--shadow-focus)] num-input" type="number" placeholder="—" class="w-[80px] text-right text-[13px] font-mono" class="rounded-sm" class="px-2 py-[5px] border border-border" name="item_lead_time_days" {} }
