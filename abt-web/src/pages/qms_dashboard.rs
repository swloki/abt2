...
fn qms_dashboard_page(
 ...
 div {
 div class="text-2xl font-bold font-mono tabular-nums tabular-nums text-fg" { (pending) }
 ...
 div {
 div class="text-2xl font-bold font-mono tabular-nums tabular-nums text-fg" { (pass_rate_str) }
 ...
 div {
 div class="text-2xl font-bold font-mono tabular-nums tabular-nums text-fg" { (fail_count) }
 ...
 div {
 div class="text-2xl font-bold font-mono tabular-nums tabular-nums text-fg" { (mrb_pending) }
 ...
 div {
 div class="text-2xl font-bold font-mono tabular-nums tabular-nums text-fg" { (rma_active) }
