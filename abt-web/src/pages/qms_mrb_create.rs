    ...
    div {
        ...
        form id="mrb-form" hx-post=(MrbCreatePath::PATH) hx-swap="none" {
            ...
            div class="form-section" {
                ...
                { (icon::link_icon("w-4 h-4")) "关联信息" }
                div class="grid grid-cols-2 gap-4 gap-x-6 mb-6" {
                    div class="form-field col-span-2" {
                        label
                            class="block text-xs font-medium text-fg-2 mb-1 whitespace-nowrap required"
                        { "关联检验结果" }
                        select
            ...
            div class="form-section" {
                div class="flex items-center gap-2 text-sm font-semibold text-fg mb-4 pb-2 border-b border-border-soft"
                { (icon::alert_triangle_icon("w-4 h-4")) "缺陷信息" }
                div class="grid grid-cols-2 gap-4 gap-x-6 mb-6" {
                    div class="form-field col-span-full" {
                        ...
                        { "缺陷描述" }
                        textarea
                            class="w-full px-3 py-2 border border-border rounded-sm text-sm bg-white text-fg transition-all duration-150 outline-none focus:border-accent min-h-[72px] resize-y leading-1.5"
                    ...
                    div class="form-field" {
                        ...
                        div class="relative" {
                            ...
                            { "¥" }
                            input
                                class="w-full pl-7 pr-3 py-2 border border-border rounded-sm text-sm bg-white text-fg transition-all duration-150 outline-none focus:border-accent"
                                type="number"
                                step="any"
                                name="cost_impact"
                                placeholder="0.00";
            ...
            div class="form-section" {
                div class="flex items-center gap-2 text-sm font-semibold text-fg mb-4 pb-2 border-b border-border-soft"
                { (icon::file_text_icon("w-4 h-4")) "备注" }
                div class="form-field" {
                    textarea
                        class="w-full px-3 py-2 border border-border rounded-sm text-sm bg-white text-fg transition-all duration-150 outline-none focus:border-accent min-h-[72px] resize-y leading-1.5"
                        name="remark"
