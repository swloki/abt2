        ...
        div {
            ...
            form id="spec-form" hx-post=(SpecCreatePath::PATH) hx-swap="none" {
                        ...
                        table class="data-table" id="check-items-table" {
                            ...
                            tbody id="check-items-body" {
                                ...
                                tr class="check-item-row" {
                                    td class="row-num" { "1" }
                                    td { input class="form-input" type="text" name="ci_item" value="外观检查"; }
                                    td { input class="form-input" type="text" name="ci_standard" value="目视无划痕"; }
                                    td { input class="form-input" type="text" name="ci_tolerance" value="无明显缺陷"; }
                                    td { input class="form-input" type="text" name="ci_method" value="目视检查"; }
                                    td { button type="button" class="btn-remove-row" title="删除行" { (icon::trash_icon("w-4 h-4")) } }
                                }
                                // Row 2: 尺寸测量
                                tr class="check-item-row" {
                                    td class="row-num" { "2" }
                                    td { input class="form-input" type="text" name="ci_item" value="尺寸测量"; }
                                    td { input class="form-input" type="text" name="ci_standard" value="图纸公差要求"; }
                                    td { input class="form-input" type="text" name="ci_tolerance" value="±0.05mm"; }
                                    td { input class="form-input" type="text" name="ci_method" value="游标卡尺"; }
                                    td { button type="button" class="btn-remove-row" title="删除行" { (icon::trash_icon("w-4 h-4")) } }
                                }
                                // Row 3: 电气性能
                                tr class="check-item-row" {
                                    td class="row-num" { "3" }
                                    td { input class="form-input" type="text" name="ci_item" value="电气性能"; }
                                    td { input class="form-input" type="text" name="ci_standard" value="额定电压电流"; }
                                    td { input class="form-input" type="text" name="ci_tolerance" value="±5%"; }
                                    td { input class="form-input" type="text" name="ci_method" value="万用表"; }
                                    td { button type="button" class="btn-remove-row" title="删除行" { (icon::trash_icon("w-4 h-4")) } }
                                }
                            }
                        }
                ...
                div class="form-section" {
                    ...
                    div class="form-grid" {
                        div class="form-field" {
                            label class="form-label" { "检验水平" }
                            select class="form-select" name="sample_level" {
                        ...
                        div class="form-field" {
                            label class="form-label" { "AQL值" }
                            select class="form-select" name="sample_aql" {
                        ...
                        div class="form-field" {
                            label class="form-label" { "抽样模式" }
                            select class="form-select" name="sample_mode" {
...
(function() {
    ...
    function createRow() {
        ...
        tr.innerHTML =
            ...
            '<td><input class="form-input" type="text" name="ci_item" placeholder="检验项目"></td>' +
            '<td><input class="form-input" type="text" name="ci_standard" placeholder="检验标准"></td>' +
            '<td><input class="form-input" type="text" name="ci_tolerance" placeholder="公差范围"></td>' +
            '<td><input class="form-input" type="text" name="ci_method" placeholder="检验方法"></td>' +
