...
fn item_row_fragment(product: &abt_core::master_data::product::model::Product) -> Markup {
 ...
 td { input class="w-[80px] text-right px-2 py-[5px] text-[13px] font-mono border border-border rounded-sm outline-none focus:border-accent" type="number" min="1" step="1" name="quantity" placeholder="0" style="width:80px" {} }
 td { input class="w-[100px] text-right px-2 py-[5px] text-[13px] font-mono border border-border rounded-sm outline-none focus:border-accent" type="number" step="any" name="unit_price" placeholder="0.00" style="width:100px" {} }
 td { input class="w-[64px] text-right px-2 py-[5px] text-[13px] font-mono border border-border rounded-sm outline-none focus:border-accent" type="number" min="0" max="100" name="discount_rate" style="width:64px" {} }
