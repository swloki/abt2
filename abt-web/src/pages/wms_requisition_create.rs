...
fn requisition_create_page(
 ...
 input class="w-full px-3 py-2 border border-border rounded-sm text-sm text-fg outline-none transition-all duration-150 focus:border-accent" type="text" readonly style="background:var(--surface)" value="admin";
 }
 }
 }
 // ── 领料明细 ──
