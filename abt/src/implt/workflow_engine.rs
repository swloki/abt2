...
use crate::implt::workflow_actions::ActionRegistry;
use crate::implt::workflow_hooks::{fire_hook, HookRegistry};
use crate::models::{
...
impl WorkflowService for WorkflowEngine {
    ...
    async fn publish_template(&self, id: i64) -> Result<()> {
        ...
        crate::implt::graph_linter::lint_graph(&graph, self.action_registry.as_ref())?;
    ...
    async fn retry_failed_hook(&self, instance_id: i64, operator_id: i64) -> Result<()> {
        crate::implt::workflow_hooks::retry_failed_hook(
            &self.pool,
            &self.hook_registry,
            instance_id,
            operator_id,
    ...
    async fn list_trigger_events(&self) -> Result<Vec<crate::models::TriggerEventDef>> {
        let triggers = crate::models::all_trigger_events();
