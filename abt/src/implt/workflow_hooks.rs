...
use crate::models::event_type::HOOK_EXECUTED;
use crate::models::WorkflowInstance;
use crate::repositories::WorkflowHistoryRepo;
...
pub async fn retry_failed_hook(
    ...
    let instance = crate::repositories::WorkflowInstanceRepo::find_by_id(pool, instance_id)
        .await?
